...
RUN apt-get update
RUN apt-get install -y qt4-qmake libqt4-dev libpq5 libpq-dev curl
...
RUN /bin/bash -l -c "curl -o Gemfile https://raw.githubusercontent.com/asm-products/zenforms/master/Gemfile && bundle install"
